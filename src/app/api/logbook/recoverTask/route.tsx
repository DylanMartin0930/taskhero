  ...
  try {
    ...
    if (task.parent) {
      ...
      if (parentTaskIndex === -1) {
        return NextResponse.json(
          { error: "Task not found in parent project" },
          { status: 404 },
        );
      }

      // Update the task in the parent project
      parentProject.tasks[parentTaskIndex].completestatus = false;
      parentProject.tasks[parentTaskIndex].completeDate = null;
